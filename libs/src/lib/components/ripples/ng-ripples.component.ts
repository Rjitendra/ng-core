  ...
  styles: [
    `
      ...
      .ng-ripples__surface {
        ...
        border-radius: 24px;
        cursor: pointer;
        background: radial-gradient(circle at top left, #1d4ed8, #0f172a 72%);
        color: white;
      }
      .ng-ripples__surface small {
        color: #93c5fd;
      }
    `,
  ],
...
export class NgRipplesComponent {
  ...
  readonly description = input(
    'Use elevated, branded ripple feedback instead of plain material defaults.',
  );
  readonly caption = input(
    'Centered, high-contrast feedback works well on glassy action surfaces.',
  );
