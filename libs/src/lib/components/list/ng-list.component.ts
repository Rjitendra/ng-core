...
export class NgListComponent {
  ...
  readonly supportingText = input(
    'Use richer rows for navigation, plans, inboxes, or account states.',
  );
  readonly items = input<NgListItem[]>([
    {
      id: '01',
      title: 'Launch readiness review',
      subtitle: 'Cross-team checkpoint with design and marketing.',
      meta: 'Today',
      icon: 'rocket_launch',
      tone: 'primary',
      selected: true,
    },
    {
      ...
      subtitle: 'Waiting for the final approver to sign.',
      meta: 'Needs action',
      icon: 'signature',
      tone: 'warning',
    },
    {
      ...
      subtitle: 'Enablement notes prepared and shared.',
      meta: 'Ready',
      icon: 'handshake',
      tone: 'success',
    },
