...
const meta: Meta<NgBottomSheetComponent> = {
  ...
  parameters: withControlDocs(NgBottomSheetComponent, {
    layout: 'padded',
  }),
};
...
export const TravelConcierge: Story = {
  args: {
    ...
    description:
      'Offer airport transfer, lounge access, and room preference updates from one premium action sheet.',
    highlight:
      'Recommended next step: confirm your arrival window before 6 PM.',
    ctaLabel: 'Open concierge sheet',
    actions: [
      {
        value: 'car',
        label: 'Reserve chauffeur',
        description: 'Private pickup with flight tracking included.',
        icon: 'directions_car',
        tone: 'primary',
      },
      {
        ...
        description: 'Invite one guest and skip the main queue.',
        icon: 'airline_seat_recline_extra',
        tone: 'success',
      },
      {
        value: 'suite',
        label: 'Request suite prep',
        description: 'Choose fragrance, lighting, and minibar presets.',
        icon: 'hotel',
        tone: 'warning',
      },
    ],
