...
@Component({
  ...
  styles: [
    `
      ...
      .ng-sidenav__brand h3,
      .ng-sidenav__content h4 {
        margin: 6px 0 0;
      }
      .ng-sidenav__item--active {
...
export class NgSidenavComponent {
  ...
  readonly items = input<NgSidenavItem[]>([
    {
      id: 'overview',
      label: 'Overview',
      caption: 'Pipeline and revenue health',
      icon: 'dashboard',
      active: true,
    },
    {
    ...
    },
    {
      id: 'briefings',
      label: 'Briefings',
      caption: 'Executive-ready updates',
      icon: 'library_books',
      tone: 'warning',
    },
  ]);
  ...
  readonly contentDescription = input(
    'Pair the sidenav with richer dashboards, filters, and action bars for a premium workspace shell.',
  );
