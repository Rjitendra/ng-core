    ...
    options: [
      {
        value: 'angular',
        label: 'Angular',
        description: 'Design system shell',
        icon: 'web',
      },
      {
        value: 'react',
    ...
    options: [
      {
        value: 'angular',
        label: 'Angular',
        description: 'Signals and Material',
      ...
      },
      {
        value: 'vue',
        label: 'Vue',
        description: 'Approachable progressive framework',
        keywords: ['frontend'],
      },
      {
        value: 'svelte',
        label: 'Svelte',
        description: 'Compiler-driven UI',
        keywords: ['frontend', 'compiler'],
      },
    ],
  },
};
